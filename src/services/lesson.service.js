...
class LessonService { 
  ...
  getLessonList(category_id) {
    return axios
      .get(API_URL+category_id+'/cat',  {headers:  authHeader()})
      .then(response => {
        return response;
      })
      .catch(err => {
  ...
  saveThumbNail(lesson_id, thumbnail) {
    ...
    return axios
      .post(API_URL+lesson_id +'/thumbnail', data , {headers:  header}).then(response => {       
        return response;
      })
      .catch(err => {
        return err;
  ...
  saveDownloadFile(lesson_id, download_file) {
    ...
    return axios
      .post(apiurl.API_URL +'downloads/'+lesson_id, data , {headers:  header}).then(response => {       
        return response;
      })
      .catch(err => {
        return err;
