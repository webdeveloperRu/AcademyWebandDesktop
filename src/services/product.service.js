...
class ProductService { 
  ...
  saveThumbNail(product_id, thumbnail) {
    ...
    return axios
      .post(API_URL+product_id +'/thumbnail', data , {headers:  header}).then(response => {       
        return response;
      })
      .catch(err => {
        return err;
  ...
  getCategoriesForProductID(product_id) {
    return axios
    .get(API_URL+product_id+'/categories',  {headers:  authHeader()})
      .then(response => {
        return response;
      })
      .catch(err => {
  ...
  getProductProgressID(product_id) {
    return axios
    .get(API_URL+product_id+'/progress',  {headers:  authHeader()})
      .then(response => {
        return response;
      })
      .catch(err => {
  ...
  getStudentProgress(product_id, student_id) {
    return axios
    .get(API_URL + product_id + '/progress/' + student_id + '?demo',  {headers:  authHeader()})
      .then(response => {
        return response;
      })
      .catch(err => {
