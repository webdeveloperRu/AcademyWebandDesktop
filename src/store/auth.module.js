...
? { status: { loggedIn: true}, user, email_code:'', email_resetpassword:'', user_log:'',twofa_logged: false, login_userinfo: null, rememberme: false } 
: { status: {loggedIn: false}, user: null, email_code:'', email_resetpassword:'', user_log:'', twofa_logged: false, login_userinfo: null, rememberme: false};
  ...
  actions: {
    ...
    logout({commit}) {
      return  AuthService.logout().then(
        res => {
            commit('integrationManage/RESET_MODULE', null, {root: true})
            ...
            commit('offerManage/RESET_MODULE', null, {root: true})
            commit('lessonManage/RESET_MODULE', null, {root: true})
            commit('peopleManage/RESET_MODULE', null, {root: true})
            commit('couponManage/RESET_MODULE', null, {root: true})
            commit('commentManage/RESET_MODULE', null, {root: true})
            commit('templateManage/RESET_MODULE', null, {root: true})
            commit('settingManage/RESET_MODULE', null, {root: true})
            commit('subuserManage/RESET_MODULE', null, {root: true})
            commit('siteDetailsManage/RESET_MODULE', null, {root: true})
            commit('paymentManage/RESET_MODULE', null, {root: true})
