...
export const commentManage = {
   ...
   */
    ...
    */
    updateCommentByID({commit}, comment) {
    ...
    * ---------delete comment id -----------------
    */
    deleteCommentByID({commit}, comment_id) {
    ...
    * ---------get comment by id -----------------
    */
    getCommentByID({commit}, comment_id) {
    ...
    */
    getCommentByLessonID({commit}, lesson_id) {
    ...
    */
    getCommentByProductID({commit}, product_id) {
     ...
     * ---------save ThmubNail------------
     */
     changeCommentStatus({commit}, comment){
