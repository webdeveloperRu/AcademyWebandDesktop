...
export const lessonManage = {
   ...
   */
    ...
    * ---------add new lesson -----------------
    */
    addLesson({commit}, [lesson, category_id]) {
    ...
    * ---------get lesson by id--------------
    */
    getLessonByID({commit}, lesson_id) {
    ...
    * ---------get comment by id--------------
    */
    getCommentByID({commit}, lesson_id) {
    ...
    * ---------update lesson by id--------------
    */
   updateLessonByID({commit},lesson) {
    ...
    * ---------update lesson list --------------
    */
   updateLessonListOrder({commit}, [lesson_list, category_id]) {
    ...
    * ---------delete lesson by id ----------------
    */
    deleteLessonByID({commit},[lesson_id, categoryIDForDelete]) {
     ...
     * ---------save ThmubNail------------
     */
     saveThumbNail({commit},[lesson_id, thumbnail]){
     ...
     * ---------remove ThmubNail------------
     */
     removeThumbNail({commit}, lesson_id){
     ...
     * ---------save Video------------
     */
     saveVideo({commit},[lesson_id, video]){
     ...
     * ---------save Dwonload file------------
     */
     saveDownloadFile({commit},[lesson_id, download_file]){
     ...
     */
     removeDownloadFile({commit}, file_id){
     ...
     */
     getDownloadFileList({commit}, lesson_id){
     ...
     * ---------remove Video------------
     */
     getDownloadFile({commit}, file_id){
     ...
     */
    changeCommentStatus({commit}, [lesson_id, status]){
