...
export const offerManage = {
   ...
   */
    ...
    * ---------delete offer id -----------------
    */
    deleteOfferByID({commit}, offer_id) {
    ...
    */
     ...
     * ---------save ThmubNail------------
     */
     saveThumbNail({commit},[offer_id, thumbnail]){
     ...
     * ---------remove ThmubNail------------
     */
    removeThumbNail({commit}, offer_id){
     ...
     */
    setTestimonialTitle({commit}, testimonial_title){
     ...
     *  add Testimonial 
     */
    addTestimonial({commit}, [testimonial, offer_id]){
     ...
     *  add Testimonial 
     */
    getTestimonial({commit}, offer_id){
     ...
     */
    getServiceAgreement({commit}, offer_id){
    ...
    saveServiceAgreement({commit}, [agreement, offer_id]){
    ...
    getExtraContactInformation({commit}, offer_id) {
    ...
    saveExtraContactInformation({commit}, [extra_info, offer_id]) {
     ...
     * ---------save banner------------
     */
    saveBanner({commit},[offer_id, banner]){
     ...
     * ---------get offer stats id------------
     */
    getOfferStats({commit}, [offer_id,days]){
      return OfferService.getOfferStats(offer_id, days).then(
        res => {
          if(res.status ===200){
            commit('getOfferStatsSuccess', {res, offer_id});
          }
          else{
            if(res.response == undefined)
                commit('NETWORK_ERROR', null, { root: true });
    ...
    * ---------get offer id -----------------
    */
   getPublicOfferByID({commit}, offer_id) {
   ...
   * set new desgin
   */
  setNewDesign({commit}, new_desgin) {
  ...
  mutations: {
    ...
    getOfferStatsSuccess(state, {res, offer_id}) {
      store.state.status = { got: true};
