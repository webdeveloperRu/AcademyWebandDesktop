...
export const templateManage = {
   ...
   */
    ...
    * ---------get template by ID-----------------
    */
   getTemplateByID({commit}, template_id) {
    ...
    */
   updateTemplate({commit}, [template, template_index]) {
      return TemplatesService.updateTemplate(template).then(
        res => {
          if(res.status ===200){
            commit('updateTemplateList', {template, template_index});
   ...
   resetTemplate({commit}, template) {
     ...
     * ---------send Test Email------------
     */
    sendTestEmail({commit},[template, email]){
  ...
  mutations: {
    ...
    updateTemplateList(state, {template, template_index}) {
