<template>
  <vs-card class="mb-0">
    <form >
      ...
      <vs-button class="w-100 vs-input-large mb-4" v-on:click="createCredential"> Create Credential</vs-button>
      <vs-button class="w-100 vs-input-large mb-4" v-on:click="deleteCredential"> Delete</vs-button>
    </form>     
  </vs-card>
</template>
