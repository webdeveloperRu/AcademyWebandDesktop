...
<div>
  <!-- banner section -->
  <div v-if="banner_enable" class="outline-edit" @click="changeSideMenu('offer-details')">
    <div class="checkout-banner" :style="{
          'background-image': cssbannerImageUrl,
          height: banner_height + 'px',
        }" v-bind:key="banner_height"></div>
  ...
  <vs-row vs-justify="center" class="mt-5">
    ...
    <vs-col vs-lg="5" class="px-5" vs-sm="7" vs-xs="12">
      <!-- 
          thumbnail section 
          -->
      <div class="outline-edit mb-5" @click="changeSideMenu('offer-details')" v-if="selected_offer.thumbnail">
    ...
    <vs-col vs-lg="4" vs-sm="5" vs-xs="12">
      <vs-card>
        <h2 v-if="selected_offer.price > 0">
        ...
        <div v-if="selected_offer.price > 0">
        ...
        <div class="outline-edit mt-3" v-if="show_required" @click="changeSideMenu('service-agreement')">
          <div class="">
            <vs-checkbox class="justify-content-start" size="small" v-model="required_agreement">I have read and agree to the terms and condition of this
              page.</vs-checkbox>
            <div class="ml-5 mt-2" v-html="custom_agree_text" v-if="service_agreement.status == 'custom_agreement'"></div>
          </div>
          <label class="edit-button" size="small">Edit</label>
        </div>
        <vs-button v-if="selected_offer.price > 0" class="w-100 mt-3" disabled>Complete my purchase</vs-button>
        <vs-button v-else class="w-100 mt-3">Sign up for free</vs-button>
      </vs-card>
    </vs-col>
  </vs-row>
</div>
