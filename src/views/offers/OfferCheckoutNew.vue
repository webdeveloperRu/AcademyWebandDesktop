  ...
  <div>
    ...
    <vs-row vs-justify="center" class="mt-5">
      ...
      <vs-col vs-lg="4" vs-sm="5" vs-xs="12">
        <vs-card>
          <h2><strong>{{selected_offer.price}}</strong> <small> {{selected_offer.currency | capitalize}}</small></h2>
          <vs-divider></vs-divider>
            ...
            <vs-button class="w-100 mt-3" disabled>Complete my purchase</vs-button>
        </vs-card>
      </vs-col>
    </vs-row>
  </div>
