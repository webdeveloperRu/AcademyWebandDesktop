...
<div>
  <vs-row vs-justify="center">
    <vs-col vs-lg="5" vs-sm="7" vs-xs="12">
      <vs-card>
      ...
      <vs-card>
        ...
        <vs-button v-if="selected_offer.price > 0" class="w-100 mt-3" color="primary">Complete your checkout</vs-button>
      ...
      <vs-card class="product-preview-item">
        ...
        <div>
          <div class="text-center p-3">
            ...
            <span v-if="selected_offer.price > 0">{{ selected_offer.price
