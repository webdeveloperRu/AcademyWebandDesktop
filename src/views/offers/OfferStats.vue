<template>
  <vs-row vs-justify="center">
    <vs-col vs-sm="12" vs-lg="11">
      <span @click="backToOffer" style="cursor: pointer;" class="ml-2 mb-5 mt-2 primary-font">
        <i class="ti-angle-left" style="font-size: 14px;"></i> {{selected_offer.name}}
      ...
      <vs-card class="cardx mt-3">
        <vs-row vs-justify="center" vs-align="center">
          <vs-col vs-w="12">
            ...
            <div>
              <vue-apex-charts type="line" height="350" :options="salesChart.chartOptions" :series="salesChart.series"></vue-apex-charts>
            </div>
          </vs-col>
        </vs-row>
      </vs-card>
      ...
      <vs-card class="cardx mt-3">
        <vs-row vs-justify="center" vs-align="center">
          <vs-col vs-w="12">
            ...
            <div>
              <vue-apex-charts type="line" height="350" :options="purchaseChart.chartOptions" :series="purchaseChart.series"></vue-apex-charts>
            </div>
          </vs-col>
        </vs-row>
      </vs-card>
  ...
  methods:{
    ...
    setOfferItem(offer_id) {
      ...
      for (let i = 0 ; i < stat_keys.length; i++) {
        ...
        purchase_values[i] = this.current_offer_stats.graphPoints[stat_keys[i]].purchases 
        sale_values[i] = this.current_offer_stats.graphPoints[stat_keys[i]].revenue
      }
