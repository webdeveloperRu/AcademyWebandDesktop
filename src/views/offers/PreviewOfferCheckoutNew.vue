...
<div>
  ...
  <div v-if="banner_enable">
    <div class="checkout-banner" :style="{'background-image': cssbannerImageUrl, 'height': banner_height + 'px'}" v-bind:key="banner_height"></div>
  ...
  <vs-row vs-justify="center" class="mt-5">
    ...
    <vs-col vs-lg="5" class="px-5" vs-sm="7" vs-xs="12">
      ...
      <div v-if="selected_public_offer.thumbnail" class="mt-5">
        <div class="checkout-image-div shadow" :style="{ 'background-image': cssthumbImageUrl }"></div>
      </div>
    ...
    <vs-col vs-lg="4" vs-sm="5" vs-xs="12">
      <vs-card>
        <h2 v-if="selected_public_offer.price > 0"><strong>{{selected_public_offer.price}}</strong> <small> {{selected_public_offer.currency | capitalize}}</small></h2>
        ...
        <div v-if="extra_contact_information.collect_name_password ">
          ...
          <vs-input class="inputx w-100 mt-3" placeholder="Confirm Password" v-model="confirmPW" type="password" />
        </div>
        ...
        <div v-if="selected_public_offer.price > 0">
          ...
          <div class="text-center">
            <img src="../../assets/images/logo/stripe_logo.png" width="20%" class="mt-3" v-if="payment_type == 'stripe'" />
            ...
            <img src="../../assets/images/logo/paypal_logo.png" width="20%" class="mt-3" v-if="payment_type == 'paypal'" />
            ...
            <img src="../../assets/images/logo/btcpay_logo.png" width="20%" class="mt-3" v-if="payment_type == 'btcpay'" />
        ...
        <div class="mt-3" v-if="show_required">
          <div class="">
            <vs-checkbox class="justify-content-start" size="small" v-model="required_agreement">I have read and agree to the terms and condition of this page.</vs-checkbox>
        ...
        <stripe-checkout ref="sessionRef" :pk="publishableKey" :session-id="sessionId" v-if="selected_public_offer.price > 0">
          <template slot="checkout-button">
            <vs-button @click="$refs.sessionRef.redirectToCheckout()" color="#42b883" class="w-100 mt-3">Checkout</vs-button>
          </template>
        </stripe-checkout>
        <vs-button v-else class="w-100 mt-3" color="primary">Sign up for free</vs-button>
      </vs-card>
    </vs-col>
  </vs-row>
</div>
...
export default {
  ...
  data: () => ({
    sessionId: '',
    publishableKey: 'pk_test_51HSAi7GPPRAMdTbIlyGMnbQwz7LsHu6CljHZfYaTW36smLIxJEQ486LirXnrTqI0uQLCcd9K64eySJCOVKcroeuy00MDTuAF05',
  ...
  methods: {
    createNewPayment() {
      ...
      this.$store.dispatch('paymentManage/createPaymentStripe', payment).then(() => {
