  ...
  <div>
    ...
    <vs-row vs-justify="center" class="mt-5">
      ...
      <vs-col vs-lg="4" vs-sm="5" vs-xs="12">
        <vs-card>
          <h2><strong>{{selected_public_offer.price}}</strong> <small> {{selected_public_offer.currency | capitalize}}</small></h2>
          <vs-divider></vs-divider>
            <vs-input v-if="extra_contact_information.collect_address"
            ...
            <div class="mt-3" v-if="show_required" >
              <div class="">
                <vs-checkbox
                  ...
                  >I have read and agree to the terms and condition of this page.</vs-checkbox>
