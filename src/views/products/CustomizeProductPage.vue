...
<div class="product-customize-page" style="margin-top: -24px">
  <div class="product-announcement" v-if="prod_header.show_announcement && prod_header.show_header" v-bind:style="{
        background: prod_header.announcement_color,
        color: prod_header.announcement_text_color,
      }">
    <div class="product-announcement-text" @click="linkToAnnouncementUrl" v-if="prod_header.announcement_new_window">
      {{ prod_header.announcement_text }}
    </div>
    <a v-if="!prod_header.announcement_new_window" class="product-announcement-text" :href="prod_header.announcement_url" v-bind:style="{
          color: prod_header.announcement_text_color,
        }">
      {{ prod_header.announcement_text }}
    </a>
  </div>
  <header class="vs-navbar topnavbar vs-navbar-null vs-navbar-color-white studentapp-header" style="background: white; margin-left: -20px" v-if="prod_header.show_header">
    ...
    <div class="outline-edit" title="Edit Product Items" @click="selectProductCustomizeMenu('header')">
      <div class="vs-con-items">
        <div class="vs-spacer"></div>
        <div class="cursor-pointer pr-2 pl-2 ml-1 mr-1">My Library</div>
        <button type="button" left="" class="vs-con-dropdown parent-dropdown cursor-pointer pr-2 pl-2 ml-1 mr-1">
  ...
  <div style="padding-top: 119px" class="product-body-layout">
    ...
    <div class="outline-edit" style="padding-top: 27px; padding-bottom: 3px; margin: 0" title="Edit Hero Section" @click="selectProductCustomizeMenu('hero')" v-if="prod_hero.show_hero">
      <div class="category-banner" v-bind:style="{
            'background-image': prod_hero.background_image,
            'text-align': hero_alignment,
            'padding-top': hero_spacing,
            'padding-bottom': hero_spacing,
          }">
        <p class="producttitle-category" v-bind:style="{ color: prod_hero.text_color }">
          {{ current_product.title }}
        </p>
        <p class="product-description-category" v-bind:style="{ color: prod_hero.text_color }">
          {{ current_product.description }}
        </p>
        <vs-button class="start-course">Start Course</vs-button>
      </div>
      <div class="hero-overlay" v-bind:style="{
    ...
    <vs-row vs-justify="center" class="primary-font">
      <vs-col type="flex" vs-justify="center" vs-align="center" vs-lg="9" vs-sm="10" vs-xs="12" code-toggler>
        <vs-row vs-justify="center" class="primary-font category-responsive">
          <vs-col type="flex" vs-justify="center" vs-align="center" vs-lg="8" vs-sm="12" vs-xs="12" code-toggler>
            <div class="outline-edit" title="Edit Category Item" @click="selectProductCustomizeMenu('welcome')" v-if="prod_welcome.show_wellcome">
              <vs-card>
                <div @click="selectProductCustomizeMenu('hero')" v-bind:style="{
            ...
            <div class="outline-edit" title="Edit Category Item" @click="selectProductCustomizeMenu('product-syllabus')">
              <vs-card>
                <h3 class="mb-3" style="cursor: pointer">category name</h3>
                <div style="cursor: pointer">
                  <vs-row vs-justify="center" vs-align="center" class="category-item mb-4 p-2">
                    <vs-col type="flex" vs-justify="center" vs-align="center" vs-lg="3" vs-sm="12" vs-xs="12" code-toggler>
                      <div class="category-image" style="cursor: pointer"></div>
                    </vs-col>
                    <vs-col type="flex" vs-justify="center" vs-align="center" vs-lg="8" vs-sm="12" vs-xs="12" code-toggler>
                      <div style="cursor: pointer">
                    ...
                    <vs-col type="flex" vs-justify="center" vs-align="center" vs-lg="1" vs-sm="12" vs-xs="12" code-toggler :title="'This lesson is completed'">
                      <vs-icon icon="check" color="danger" style="font-size: 20px"></vs-icon>
                    </vs-col>
                  </vs-row>
                </div>
                <div>
                  <div color="danger" style="cursor: pointer; color: dodgerblue">
                    View More
                  </div>
                </div>
              </vs-card>
          ...
          <vs-col type="flex" vs-justify="center" vs-align="center" vs-lg="4" vs-sm="12" vs-xs="12" code-toggler v-if="prod_sidebar.show_sidebar">
            <vs-card class="progress-product_thumbnail">
              ...
              <div class="mx-4 mt-3">
                ...
                <div title="Edit Progress bar Color">
                  <vs-progress :percent="80" color="primary">primary</vs-progress>
                  <label class="edit-button" size="small">Edit</label>
                </div>
              </div>
            </vs-card>
  ...
  <!-- footer section -->
  <div class="outline-edit footer-layout" title="Edit footer section" @click="selectProductCustomizeMenu('footer')">
    <footer class="footer footer--dark footer--left" kjb-settings-id="sections_footer_settings_background_color" v-if="prod_footer.show_footer" v-bind:style="{
          background: prod_footer.background_color,
        }">
      <div class="container">
        <div class="footer__text-container">
          <span v-if="prod_footer.show_copyright" kjb-settings-id="sections_footer_settings_copyright" class="footer__copyright" v-bind:style="{
                color: prod_footer.text_color,
              }">{{ prod_footer.copyright_text }}</span>
        </div>
        <div class="footer-icon-layout" v-if="prod_footer.show_social_icons" v-bind:style="{
              'justify-content': social_icon_alignment,
            }">
          <div v-if="prod_footer.sil_facebook != ''" class="footer-icon" v-bind:style="{
          ...
          <div v-if="prod_footer.sil_twitter != ''" class="footer-icon" v-bind:style="{
                color: prod_footer.social_icon_color,
                background: social_icon_background_color,
                'border-radius': social_icon_border_radius,
              }">
          ...
          <div v-if="prod_footer.sil_instagram != ''" class="footer-icon" v-bind:style="{
                color: prod_footer.social_icon_color,
                background: social_icon_background_color,
                'border-radius': social_icon_border_radius,
              }">
          ...
          <div v-if="prod_footer.sil_youtube != ''" class="footer-icon" v-bind:style="{
                color: prod_footer.social_icon_color,
                background: social_icon_background_color,
                'border-radius': social_icon_border_radius,
              }">
          ...
          <div v-if="prod_footer.sil_vimeo != ''" class="footer-icon" v-bind:style="{
                color: prod_footer.social_icon_color,
                background: social_icon_background_color,
                'border-radius': social_icon_border_radius,
              }">
          ...
          <div v-if="prod_footer.sil_github != ''" class="footer-icon" v-bind:style="{
                color: prod_footer.social_icon_color,
                background: social_icon_background_color,
                'border-radius': social_icon_border_radius,
              }">
          ...
          <div v-if="prod_footer.sil_itunes != ''" class="footer-icon" v-bind:style="{
                color: prod_footer.social_icon_color,
                background: social_icon_background_color,
                'border-radius': social_icon_border_radius,
              }">
          ...
          <div v-if="prod_footer.sil_linkedin != ''" class="footer-icon" v-bind:style="{
                color: prod_footer.social_icon_color,
                background: social_icon_background_color,
                'border-radius': social_icon_border_radius,
              }">
          ...
          <div v-if="prod_footer.sil_soundcloud != ''" class="footer-icon" v-bind:style="{
                color: prod_footer.social_icon_color,
                background: social_icon_background_color,
                'border-radius': social_icon_border_radius,
              }">
          ...
          <div v-if="prod_footer.sil_tumblr != ''" class="footer-icon" v-bind:style="{
                color: prod_footer.social_icon_color,
                background: social_icon_background_color,
                'border-radius': social_icon_border_radius,
              }">
          ...
          <div v-if="prod_footer.sil_flickr != ''" class="footer-icon" v-bind:style="{
                color: prod_footer.social_icon_color,
                background: social_icon_background_color,
                'border-radius': social_icon_border_radius,
              }">
          ...
          <div v-if="prod_footer.sil_slack != ''" class="footer-icon" v-bind:style="{
                color: prod_footer.social_icon_color,
                background: social_icon_background_color,
                'border-radius': social_icon_border_radius,
              }">
          ...
          <div v-if="prod_footer.sil_dribbble != ''" class="footer-icon" v-bind:style="{
                color: prod_footer.social_icon_color,
                background: social_icon_background_color,
                'border-radius': social_icon_border_radius,
              }">
