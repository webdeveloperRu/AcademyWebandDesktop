      ...
      <div >
        ...
        <div class="text-center m-2">
          <vs-tooltip color="dark" :text="product_title">
            <h3 class="mb-2 product-title" :title="product_title" >{{product_title}}</h3>
          </vs-tooltip>
          <i class="mdi mdi-account-multiple mr-2"></i>{{product_members}} members
        </div>
        <div class="project-preview-icon">
          ...
          <vs-dropdown vs-trigger-click>
            ...
            <vs-dropdown-menu>
             ...
             <!--  <vs-dropdown-item>
              ...
              <vs-dropdown-item>
                <div class="ml-3 mr-3 primary-font-color w-100" 
                  style="font-size: 16px" v-on:click="editProductDetails">
                  Edit Details 
                </div>
              </vs-dropdown-item>
               ...
               <vs-dropdown-item>
                <div class="ml-3 mr-3 primary-font-color w-100" 
                  style="font-size: 16px" @click="gotoPreview">
                  Preview
                </div>
              </vs-dropdown-item>
              ...
              <vs-dropdown-item>
                <div class="ml-3 mr-3 primary-font-color" 
                  style="font-size: 16px" @click="linkToStudentProgress">
                  Students Progress
                </div>
              </vs-dropdown-item>
              ...
              <vs-dropdown-item>
                <div class="ml-3 mr-3 primary-font-color" 
                  style="font-size: 16px" @click="linkToManageComments">
                  Manage Comments
                </div>
              </vs-dropdown-item>
          ...
          <vs-popup class="product-delete" title="" :active.sync="confirmDeleteProduct">
            <div style="font-size: 25px; color: white" class="px-5 bg-danger m-0 ">
              <i class="mdi mdi-alert"></i> Are you sure you want to delete <strong>"{{product.title}}"</strong> ?
  ...
  methods: {
    ...
    **/
    ...
    deleteCurrentProduct() {
      this.$store.dispatch('productManage/deleteProductByID', this.product.id).then(()=>{
        this.$vs.notify({
