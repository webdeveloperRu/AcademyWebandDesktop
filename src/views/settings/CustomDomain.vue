        ...
        >
          <vs-card class="cardx">
             <vs-input
              ...
              class="w-100 mt-3"
            />
            <label class="mt-2">Example: "www.example.com" or "courses.example.com"</label>
          </vs-card>
        </vs-col>
      </vs-row>
...
export default {
  ...
  methods: {
    getCustomDomain() {
      this.$store.dispatch('settingManage/getCustomDomain').then(()=>{
    ...
    setCustomDomain() {
      ...
      this.$store.dispatch('settingManage/setCustomDomain', domain).then(()=>{
        this.$vs.notify({
          color: this.notification_color,
          text: this.notification_text,
          icon: this.notification_icon
