  ...
  <vs-row vs-justify="center" class="primary-font">
    ...
    >
      <vs-card>
        ...
        <vs-divider />
          ...
          <vs-row class="ml-2" >
            <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
              <img :src="mailchimp_config.icon" width="50px" alt="mailchimp" @click="mailchimp_edit = !mailchimp_edit" style="cursor:pointer;"/>
            </vs-col>
            <vs-col vs-lg="10" vs-xs="6" vs-sm="8">
              <div @click="mailchimp_edit = !mailchimp_edit" style="cursor:pointer;">
                <h4>{{mailchimp_config.name}}</h4>
                  ...
                  <div v-if="mailchimp_edit">
                    ...
                    <div style="display: flex;justify-content: flex-end;" v-if="mailchimp_changed">
                      <vs-button class="mt-4"  color="primary" @click="saveThirdPartyConfiguration(mailchimp_config.slug)"> save </vs-button>
                    </div>
                  </div>
            </vs-col>
            <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
              <vs-switch color="green" v-model="mailchimp_status" @click="changeThirdPartyIntegraitonSatus(mailchimp_config.slug)">
        ...
        <vs-row class="ml-2">
          <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
            <img :src="drip_config.icon" width="50px" alt="Drip" @click="drip_edit = !drip_edit" style="cursor:pointer;"/>
          </vs-col>
          <vs-col vs-lg="10" vs-xs="6" vs-sm="8">
            <div @click="drip_edit = !drip_edit" style="cursor:pointer;">
              ...
              <div v-if="drip_edit">
                ...
                <vs-input
                  ...
                  class="w-100 mt-2"
                />
                <div style="display: flex;justify-content: flex-end;" v-if="drip_changed">
                  <vs-button class="mt-4"  color="primary" @click="saveThirdPartyConfiguration(drip_config.slug)"> save </vs-button>
                </div>
              </div>
          </vs-col>
          <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
            <vs-switch color="green" v-model="drip_status" @click="changeThirdPartyIntegraitonSatus(drip_config.slug)">
              <span slot="on">On</span>
              <span slot="off">Off</span>
            </vs-switch>
          </vs-col>
          ...
          <vs-row class="ml-2">
            <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
              <img
                ...
                width="50px"
                alt="ConvertKit"
                @click="convert_kit_edit = !convert_kit_edit" style="cursor:pointer;"
              />
            </vs-col>
            <vs-col vs-lg="10" vs-xs="6" vs-sm="8">
              <div @click="convert_kit_edit = !convert_kit_edit" style="cursor:pointer;">
                ...
                <div v-if="convert_kit_edit">
                  ...
                  <div style="display: flex;justify-content: flex-end;" v-if="convert_kit_changed">
                    <vs-button class="mt-4"  color="primary" @click="saveThirdPartyConfiguration(convert_kit_config.slug)"> save </vs-button>
                  </div>
                </div>
            </vs-col>
            <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
              <vs-switch color="green" v-model="convert_kit_status" @click="changeThirdPartyIntegraitonSatus(convert_kit_config.slug)">
                <span slot="on">On</span>
                <span slot="off">Off</span>
              </vs-switch>
            </vs-col>
        ...
        active campaign
         -->
          <vs-row class="ml-2">
            ...
            <vs-col vs-lg="10" vs-xs="6" vs-sm="8">
              <div @click="active_campaign_edit = !active_campaign_edit" style="cursor:pointer;">
                ...
                <div v-if="active_campaign_edit">
                  ...
                  <div style="display: flex;justify-content: flex-end;" v-if="active_campaign_changed">
                    <vs-button class="mt-4"  color="primary" @click="saveThirdPartyConfiguration(active_campaign_config.slug)"> save </vs-button>
                  </div>  
                </div>
            </vs-col>
            <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
              <vs-switch color="green" v-model="active_campaign_status" @click="changeThirdPartyIntegraitonSatus(active_campaign_config.slug)">
                <span slot="on">On</span>
                <span slot="off">Off</span>
              </vs-switch>
            </vs-col>
        ...
        <vs-divider />
          <vs-row class="ml-2">
            <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
              <img :src="segment_config.icon" width="50px" alt="Segment" @click="segment_edit = !segment_edit" style="cursor:pointer;"/>
            </vs-col>
            <vs-col vs-lg="10" vs-xs="6" vs-sm="8">
              <div @click="segment_edit = !segment_edit" style="cursor:pointer;">
                ...
                <div v-if="segment_edit">
                  ...
                  <div style="display: flex;justify-content: flex-end;" v-if="segment_changed">
                    <vs-button class="mt-4"  color="primary" @click="saveThirdPartyConfiguration(segment_config.slug)"> save </vs-button>
                  </div>
                </div>
            </vs-col>
            <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
              <vs-switch color="green" v-model="segment_status" @click="changeThirdPartyIntegraitonSatus(segment_config.slug)">
                <span slot="on">On</span>
                <span slot="off">Off</span>
              </vs-switch>
            </vs-col>
        ...
        <vs-divider />
          <vs-row class="ml-2">
            ...
            <vs-col vs-lg="10" vs-xs="6" vs-sm="8">
              <div @click="google_analytics_edit = !google_analytics_edit" style="cursor:pointer;">
                ...
                <div v-if="google_analytics_edit">
                  ...
                  <div style="display: flex;justify-content: flex-end;" v-if="google_analytics_changed">
                    <vs-button class="mt-4"  color="primary" @click="saveThirdPartyConfiguration(google_analytics_config.slug)"> save </vs-button>
                  </div>
                </div>
            </vs-col>
            <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
              <vs-switch color="green" v-model="google_analytics_status" @click="changeThirdPartyIntegraitonSatus(google_analytics_config.slug)">
                <span slot="on">On</span>
                <span slot="off">Off</span>
              </vs-switch>
            </vs-col>
          ...
          <vs-row class="ml-2">
            <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
              <img
                ...
                width="50px"
                alt="Facebook Pixel"
                @click="facebook_pixel_edit = !facebook_pixel_edit" style="cursor:pointer;"
              />
            </vs-col>
            <vs-col vs-lg="10" vs-xs="6" vs-sm="8">
              <div @click="facebook_pixel_edit = !facebook_pixel_edit" style="cursor:pointer;">
                ...
                <div v-if="facebook_pixel_edit">
                  ...
                  />
                  <label class="mt-2"
                    >{{facebook_pixel_config.help}}
                  </label>
                  <div style="display: flex;justify-content: flex-end;" v-if="facebook_pixel_changed">
                    <vs-button class="mt-4"  color="primary" @click="saveThirdPartyConfiguration(facebook_pixel_config.slug)"> save </vs-button>
                  </div>
                </div>
            </vs-col>
            <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
              <vs-switch color="green" v-model="facebook_pixel_status" @click="changeThirdPartyIntegraitonSatus(facebook_pixel_config.slug)">
                <span slot="on">On</span>
                <span slot="off">Off</span>
              </vs-switch>
            </vs-col>
          ...
          <vs-row class="ml-2">
            <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
              <img
                ...
                width="50px"
                alt="AWS icon"
                @click="amazon_edit = !amazon_edit" style="cursor:pointer;"
              />
            </vs-col>
            <vs-col vs-lg="10" vs-xs="6" vs-sm="8">
              <div @click="amazon_edit = !amazon_edit" style="cursor:pointer;">
                ...
                <div v-if="amazon_edit">
                  ...
                  <div style="display: flex;justify-content: flex-end;" v-if="amazon_changed">
                    <vs-button class="mt-4"  color="primary" @click="saveThirdPartyConfiguration(amazon_config.slug)"> save </vs-button>
                  </div>
                </div>
            </vs-col>
            <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
              <vs-switch color="green" v-model="amazon_status" @click="changeThirdPartyIntegraitonSatus(amazon_config.slug)">
                <span slot="on">On</span>
                <span slot="off">Off</span>
              </vs-switch>
            </vs-col>
          ...
          <vs-row class="ml-2">
            <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
              <img
                ...
                width="50px"
                alt="PayPal"
                @click="paypal_edit = !paypal_edit" style="cursor:pointer;"
              />
            </vs-col>
            <vs-col vs-lg="10" vs-xs="6" vs-sm="8">
              <div @click="paypal_edit = !paypal_edit" style="cursor:pointer;">
                ...
                <div v-if="paypal_edit">
                  ...
                  <div style="display: flex;justify-content: flex-end;" v-if="paypal_changed">
                    <vs-button class="mt-4"  color="primary" @click="saveThirdPartyConfiguration(paypal_config.slug)"> save </vs-button>
                  </div>
                </div>
            </vs-col>
            <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
              <vs-switch color="green" v-model="paypal_status" @click="changeThirdPartyIntegraitonSatus(paypal_config.slug)">
                <span slot="on">On</span>
                <span slot="off">Off</span>
              </vs-switch>
            </vs-col>
          ...
          <vs-row class="ml-2">
            <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
              <img
                ...
                width="50px"
                alt="Stripe"
                @click="stripe_edit = !stripe_edit" style="cursor:pointer;"
              />
            </vs-col>
            <vs-col vs-lg="10" vs-xs="6" vs-sm="8">
              <div @click="stripe_edit = !stripe_edit" style="cursor:pointer;">
                ...
                <div v-if="stripe_edit">
                  ...
                  <div style="display: flex;justify-content: flex-end;" v-if="stripe_changed">
                    <vs-button class="mt-4"  color="primary" @click="saveThirdPartyConfiguration(stripe_config.slug)"> save </vs-button>
                  </div>
                </div>
            </vs-col>
            <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
              <vs-switch color="green" v-model="stripe_status" @click="changeThirdPartyIntegraitonSatus(stripe_config.slug)">
                <span slot="on">On</span>
                <span slot="off">Off</span>
              </vs-switch>
            </vs-col>
          ...
          <vs-row class="ml-2">
            <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
              <img
                ...
                width="50px"
                alt="Btcpay"
                click="btcpay_edit = !btcpay_edit" style="cursor:pointer;"
              />
            </vs-col>
            <vs-col vs-lg="10" vs-xs="6" vs-sm="8">
              <div @click="btcpay_edit = !btcpay_edit" style="cursor:pointer;">
                ...
                <div v-if="btcpay_edit">
                  ...
                  <div style="display: flex;justify-content: flex-end;" v-if="btcpay_changed">
                    <vs-button class="mt-4"  color="primary" @click="saveThirdPartyConfiguration(btcpay_config.slug)"> save </vs-button>
                  </div>
                </div>
            </vs-col>
            <vs-col vs-lg="1" vs-xs="3" vs-sm="2">
              <vs-switch color="green" v-model="btcpay_status"  @click="changeThirdPartyIntegraitonSatus(btcpay_config.slug)">
                <span slot="on">On</span>
                <span slot="off">Off</span>
              </vs-switch>
            </vs-col>
...
export default {
  ...
  watch: {
    ...
    aws_region: function(newValue){
      if(this.amazon_data.data == undefined) {
        if(newValue !== '' && this.aws_bucket_name !== '' && this.aws_secret_access_key !== '' && this.aws_access_key_id !== '')
    ...
    aws_bucket_name: function(newValue){
      if(this.amazon_data.data == undefined) {
        if(newValue !== '' && this.aws_region !== '' && this.aws_secret_access_key !== '' && this.aws_access_key_id !== '')
          this.amazon_changed = true;
        else 
          this.amazon_changed = false;
    ...
    aws_access_keyID: function(newValue){
      if(this.amazon_data.data == undefined) {
        if(newValue !== '' && this.aws_region !== '' && this.aws_secret_access_key !== '' && this.aws_bucket_name !== '')
          this.amazon_changed = true;
        else 
          this.amazon_changed = false;
    ...
    aws_secret_access_key: function(newValue){
      if(this.amazon_data.data == undefined) {
        if(newValue !== '' && this.aws_region !== '' && this.aws_secret_access_key !== '' && this.aws_access_keyID !== '')
          this.amazon_changed = true;
        else 
          this.amazon_changed = false;
  ...
  methods: {
    ...
    getAllIntegrations() {
      this.$store.dispatch('integrationManage/getIntegrationList').then(()=>{
    ...
    saveThirdPartyConfiguration(slug) {
      ...
      if(slug == this.mailchimp_config.slug) {
        ...
        this.$store.dispatch('integrationManage/setupIntegrationConfig', mailchimp).then(()=>{
           this.$vs.notify({
      ...
      if(slug == this.drip_config.slug) {
        ...
        this.$store.dispatch('integrationManage/setupIntegrationConfig', drip).then(()=>{
           this.$vs.notify({
              title: "Drip setting" ,           
              color: this.notification_color,
              text: this.notification_text,
      ...
      if(slug == this.convert_kit_config.slug) {
        ...
        this.$store.dispatch('integrationManage/setupIntegrationConfig', convert_kit).then(()=>{
           this.$vs.notify({
      ...
      if(slug == this.active_campaign_config.slug) {
        let active_campaign = {
          data:{api_key: this.active_campaign_apikey,
                api_url: this.active_campaign_apiurl},
          slug: this.active_campaign_config.slug
        }

        this.$store.dispatch('integrationManage/setupIntegrationConfig', active_campaign).then(()=>{
           this.$vs.notify({
      ...
      if(slug == this.segment_config.slug) {
        ...
        this.$store.dispatch('integrationManage/setupIntegrationConfig', segment).then(()=>{
           this.$vs.notify({
      ...
      if(slug == this.google_analytics_config.slug) {
        ...
        this.$store.dispatch('integrationManage/setupIntegrationConfig', google_analytics).then(()=>{
           this.$vs.notify({
      ...
      if(slug == this.facebook_pixel_config.slug) {
        ...
        this.$store.dispatch('integrationManage/setupIntegrationConfig', facebook_pixel).then(()=>{
           this.$vs.notify({
      ...
      if(slug == this.amazon_config.slug) {
        let amazon = {
          data: { aws_access_key_id : this.aws_access_keyID, 
        ...
        this.$store.dispatch('integrationManage/setupIntegrationConfig', amazon).then(()=>{
           this.$vs.notify({
      ...
      if( slug == this.paypal_config.slug) {
        let paypal = {
          data: { email : this.paypal_email, 
                  token : this.paypal_token,
                },
          slug: this.paypal_config.slug
        }

        this.$store.dispatch('integrationManage/setupIntegrationConfig', paypal).then(()=>{
           this.$vs.notify({
      ...
      if(slug == this.stripe_config.slug) {
        let paypal = {
          data: { STRIPE_PUBLISHABLE_KEY : this.stripe_publish_key, 
      ...
      if(slug == this.btcpay_config.slug) {
        let btcpay = {
          data: { server_url : this.btcpay_server_url, 
                  pair_code : this.btcpay_pair_code,
                },
          slug: this.btcpay_config.slug
        }

        this.$store.dispatch('integrationManage/setupIntegrationConfig', btcpay).then(()=>{
           this.$vs.notify({
    ...
    getThirdPartyIntegrationConfig(slug) {
      this.$store.dispatch('integrationManage/getIntegrationConfig', slug).then(()=>{
         switch (slug) {
            case 'mailchimp':
    ...
    changeThirdPartyIntegraitonSatus(slug) {
       switch (slug) {
            case 'mailchimp':
              if (this.mailchimp_status == false)
                this.mailchimp_edit = true;
              else
                this.mailchimp_edit = false;
              break;

            case 'drip':
              if (this.drip_status == false)
                this.drip_edit = true;
              else
                this.drip_edit = false;
              break;

            case 'convert_kit':
              if (this.convert_kit_status == false)
                this.convert_kit_edit = true;
              else
                this.convert_kit_edit = false;
              break;
            ...
            case 'active_campaign':
              if (this.active_campaign_status == false)
                ...
                this.active_campaign_edit = false;
              break;

            case 'segment':
              if (this.segment_status == false)
                this.segment_edit = true;
              else
                this.segment_edit = false;
              break;
            ...
            case 'google_analytics':
              if (this.google_analytics_status == false)
                ...
                this.google_analytics_edit = false;
              break;
            ...
            case 'facebook_pixel':
              if (this.facebook_pixel_status == false)
                ...
                this.facebook_pixel_edit = false;
              break;

            case 'amazon_s3':
              if (this.amazon_status == false)
                this.amazon_edit = true;
              else
                this.amazon_edit = false;
              break;

            case 'paypal':
              if (this.paypal_status == false)
            ...
            case 'stripe':
              ...
              if (this.stripe_status == false)
                this.stripe_edit = true;
              else
                this.stripe_edit = false;
              break;

            case 'btcpay':
              if (this.btcpay_status == false)
                this.btcpay_edit = true;
              else
                this.btcpay_edit = false;
              break;
          }
    }
